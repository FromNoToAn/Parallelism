...
if __name__ == "__main__":
	...
	parser.add_argument('--video', type=str, default="test.mp4",  help='input video')
	parser.add_argument('--threads', type=int, default=2, help='number threads')
	parser.add_argument('--output', type=str, default="result.mp4",  help='output video')
	...
	vidos = cv2.VideoWriter(args.output, -1, 30, (w, h))
